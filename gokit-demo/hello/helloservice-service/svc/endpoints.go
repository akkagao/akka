...
func (e Endpoints) SayHello(ctx context.Context, in *pb.HelloRequest) (*pb.HelloResponse, error) {
...
func MakeSayHelloEndpoint(s pb.HelloServiceServer) endpoint.Endpoint {
